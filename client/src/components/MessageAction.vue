...
<template>
  <div class="border-t-2 border-gray-900 px-4 pt-4 mb-2 sm:mb-0 border-opacity-20">
    <div class="relative flex bg-gray-700">
      ...
      <input type="text" placeholder="Write your message!" class="w-full focus:outline-none focus:placeholder-gray-400 text-gray-600 placeholder-gray-600 pl-10 bg-gray-200 rounded-md py-3">
